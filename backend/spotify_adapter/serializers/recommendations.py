...
class RecommendationsParamsSerializer(serializers.Serializer):
    ...
    min_acousticness = NormalizedFloatField(
        required=False, help_text=GENERIC_MIN_PARAM_HELP_TEXT
    )
    max_acousticness = NormalizedFloatField(
        required=False, help_text=GENERIC_MAX_PARAM_HELP_TEXT
    )
    target_acousticness = NormalizedFloatField(
        required=False, help_text=GENERIC_TARGET_PARAM_HELP_TEXT
    )
    ...
    min_duration_ms = serializers.IntegerField(
        required=False, min_value=1, help_text=GENERIC_MIN_PARAM_HELP_TEXT
    )
    max_duration_ms = serializers.IntegerField(
        required=False, min_value=1, help_text=GENERIC_MAX_PARAM_HELP_TEXT
    )
    target_duration_ms = serializers.IntegerField(
        required=False, min_value=1, help_text=_("Target duration of the track (ms)")
    )
    min_energy = serializers.FloatField(
        required=False, min_value=0, max_value=1, help_text=GENERIC_MIN_PARAM_HELP_TEXT
    )
    max_energy = serializers.FloatField(
        required=False, min_value=0, max_value=1, help_text=GENERIC_MAX_PARAM_HELP_TEXT
    )
    ...
    min_key = serializers.IntegerField(
        required=False, min_value=0, max_value=11, help_text=GENERIC_MIN_PARAM_HELP_TEXT
    )
    max_key = serializers.IntegerField(
        required=False, min_value=0, max_value=11, help_text=GENERIC_MAX_PARAM_HELP_TEXT
    )
    ...
    target_tempo = serializers.IntegerField(
        required=False, min_value=1, help_text=_("Target tempo (BPM)")
    )
    min_time_signature = serializers.IntegerField(
        required=False, min_value=0, max_value=5, help_text=GENERIC_MIN_PARAM_HELP_TEXT
    )
    max_time_signature = serializers.IntegerField(
        required=False, min_value=0, max_value=5, help_text=GENERIC_MAX_PARAM_HELP_TEXT
    )
    ...
    def validate(self, attrs: dict) -> dict:
        ...
        if not any([seed_artists, seed_genres, seed_tracks]):
            message = _(
                "At least one of `seed_artists`, `seed_genres`, `seed_tracks` is required"
            )
