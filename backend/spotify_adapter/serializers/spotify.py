...
class ExternalURLSerializer(serializers.Serializer):
    spotify = serializers.URLField(help_text=_("The Spotify URL for the object."))


class ImageSerializer(serializers.Serializer):
    url = serializers.URLField(help_text=_("The source URL of the image."))
    height = serializers.IntegerField(
        allow_null=True, help_text=_("The image height in pixels.")
    )
    width = serializers.IntegerField(
        allow_null=True, help_text=_("The image width in pixels.")
    )
...
class SimplifiedArtistSerializer(serializers.Serializer):
    ...
    id = serializers.CharField(help_text=_("The Spotify ID for the artist."))
    name = serializers.CharField(help_text=_("The name of the artist."))
    type = serializers.CharField(
        default="artist", help_text=_('The object type: "artist"')
    )
    uri = serializers.CharField(help_text=_("The Spotify URI for the artist."))
...
class LinkedFromSerializer(serializers.Serializer):
    ...
    type = serializers.CharField(
        default="track", help_text=_('The object type: "track"')
    )
...
class SimplifiedTrackSerializer(serializers.Serializer):
    ...
    external_urls = ExternalURLSerializer(help_text=_("External URLs for this track."))
    href = serializers.URLField(
        help_text=_(
            "A link to the Web API endpoint providing full details of the track."
        )
    ...
    name = serializers.CharField(help_text=_("The name of the track."))
...
class CopyrightSerializer(serializers.Serializer):
    text = serializers.CharField(help_text=_("The copyright text for this content."))
...
class ExternalIdsSerializer(serializers.Serializer):
    isrc = serializers.CharField(help_text="International Standard Recording Code")
    ean = serializers.CharField(help_text="International Article Number")
    upc = serializers.CharField(help_text="Universal Product Code")
