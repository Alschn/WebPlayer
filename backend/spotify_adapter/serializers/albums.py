...
class AlbumSerializer(serializers.Serializer):
    ...
    total_tracks = serializers.IntegerField(
        min_value=0, help_text=_("The number of tracks in the album.")
    )
    ...
    id = serializers.CharField(help_text=_("The Spotify ID for the album."))
    ...
    type = serializers.CharField(
        help_text=_('The object type: "album".'), default="album"
    )
    uri = serializers.CharField(help_text=_("The Spotify URI for the album."))
    ...
    tracks = AlbumTracksPageSerializer(help_text=_("The tracks of the album."))
    copyrights = CopyrightSerializer(
        many=True, help_text=_("The copyright statements of the album.")
    )
    ...
    label = serializers.CharField(
        allow_blank=True, help_text=_("The label associated with the album.")
    )
